...
Description: This cloud parcel model simulates the updraft cooling of a cloud parcel with entrainment-mixing and entrained aerosols. The initial development of this model was supported by Stony Brook University and Brookhaven National Laboratory.

Author        : Jingyi Chen, PhD
                Research Scientist
                Pacific Northwest National Laboratory (current affiliation)
                Email: jingyichen89@gmail.com or jingyi.chen@pnnl.gov
                
Terms of Use  : (1) The parcel model code may be used for educational or non-profit purposes only. Any other usage must be first approved by the author.
